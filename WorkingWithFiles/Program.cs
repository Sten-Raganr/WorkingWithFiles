...
namespace WorkingWithFiles
{
    class Program
    {
        ...
        public static void Fruit(string dateString)
        {
            ...
            string fullSourceFile = @"C:\Users\stenk\samples\LOGITpe20-Week12-WorkingWithFiles-Task\" + sourceFile + ".txt";
            File.WriteAllText(fullSourceFile, dateString);
            string fullDestinationFile = @"C:\Users\stenk\samples\LOGITpe20-Week12-WorkingWithFiles-Task\fruit\" + sourceFile + ".txt";
        ...
        public static void Vegetable(string dateString)
        {
            ...
            string fullSourceFile = @"C:\Users\stenk\samples\LOGITpe20-Week12-WorkingWithFiles-Task\" + sourceFile + ".txt";
            File.WriteAllText(fullSourceFile, dateString);
            string fullDestinationFile = @"C:\Users\stenk\samples\LOGITpe20-Week12-WorkingWithFiles-Task\vegetables\" + sourceFile + ".txt";
        ...
        public static void FileDeleter()
        {
            ...
            string sourceFile = Console.ReadLine();
            string fullFile = @"C:\Users\stennk\samples\LOGITpe20-Week12-WorkingWithFiles-Task" + sourceFolder + sourceFile + ".txt";
